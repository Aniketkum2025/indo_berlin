...
@section('content')
 ...
 <div class="bg-white text-center p-8 rounded-lg shadow-lg max-w-6xl mx-auto w-full border border-red-300 my-8">
    ...
    <p class="mb-6 text-gray-600">To connect with a dedicated expert counselor, please let us know which course you are interested in inquiring about.</p>
 ...
 <div class="w-full max-w-md mx-auto text-left text-red-600" x-data="dropdown()">
    ...
    <div class="relative">
      <button @click="toggle" class="w-full border border-gray-300 bg-white text-black rounded-md px-4 py-3 text-left shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 flex justify-between items-center">
      ...
      <!-- Dropdown Panel -->
      <div x-show="open" x-transition class="absolute z-10 mt-2 w-full bg-white border border-gray-300 rounded-md shadow-lg">
        <!-- Search Box -->
        <div class="p-2">
          <input type="text" placeholder="Search..." x-model="search" class="w-full border border-gray-300 px-3 py-2 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-red-500" />
        </div>
 ...
 <div class="text-center my-6">
    <a href="https://zoom.us/j/93024133145?pwd=QfibdAB6meQtEtyQlaPaePkXqaDLqG.1" class="bg-red-600 py-2 px-6 text-white text-xl rounded-3xl border border-white">
