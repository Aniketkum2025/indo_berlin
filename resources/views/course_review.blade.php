...
{{-- <section id="video_review_course_section" class="bg-white shadow-lg rounded-3xl p-8 md:p-10 border border-gray-100">
    <h2 class="md:text-[32px] text-[20px] text-purple md:mx-[2%] mx-[2%] italic py-4 text-center md:leading-[30px] leading-[20px]">
        Check out Henry Harvin® {{ $course->course_name }} alumna on YouTube
    </h2>
