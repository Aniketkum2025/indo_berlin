        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                @foreach ($feedbacks as $feedback)
                    <div
                        class="swiper-slide bg-white rounded-lg shadow-lg border border-red-200 flex flex-col items-center text-center">
                        ...
                        <div class="bg-yellow-100 p-4 text-sm text-gray-800">
                            {{ $feedback['text'] }}
                            <p class="text-red-600 font-medium mt-2">- {{ $feedback['name'] }}</p>
                        </div>

                        <div class="bg-red-700 text-white font-semibold w-full py-2">
                            {{ $feedback['role'] }}
                        </div>
                    </div>
                @endforeach
