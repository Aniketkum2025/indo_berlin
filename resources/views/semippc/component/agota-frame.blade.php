<section class="py-12 mx-auto px-4">
    <div class="max-w-6xl mx-auto">
        <h2 class="text-center text-2xl md:text-3xl font-semibold mb-2 text-orange-600 capitalize my-4">
            Agota™ Framework
        </h2>
        <p class="text-[16px] text-gray-800 font-[600] text-center">
            ...
            <span class="font-bold text-gray-900">
                The 能力 (Nōryoku) development and キャリア (Kyaria) development.
            </span>
        </p>

        <p class="text-[16px] text-gray-800 font-[600] text-center mt-4">
            <span class="font-bold text-gray-900">能力 (Nōryoku) development </span> is about building capabilities that
            not only meet
            current job demands but also anticipates the future needs. It includes:
        </p>

        <div class="relative grid md:grid-cols-2 gap-2 my-2">
            <div>
                <ul class="disk mt-2">
                    <li class="grid md:grid-cols-2 grid-cols-1 gap-4 justify-between">
                        <div
                            class="text-[15px] py-2 text-left font-[600] grid grid-cols-3 gap-2 border-b border-purple">
                            ...
                            <div class="relative h-fit mx-auto mb-4 mt-2">
                    ...
                    <li class="grid md:grid-cols-2 grid-cols-1 gap-4 justify-between">
                        <div
                            ...
                            <p class="col-span-2 text-orange-600">
                                ...
                                <span class="block text-[12px] text-gray-800 font-[600]"> Free Access to #AskHenry
                                    Hackathons and Competitions &amp; many other facilities from Kazumi Language
                                    School</span>
                            </p>
                            <div class="relative h-fit mx-auto mb-4 mt-2">
                                <img src="https://d1d5cy0fmpy9m8.cloudfront.net/images/1719576156sxw (2).webp"
                        ...
                        <div
                            ...
                            <div class="relative h-fit mx-auto mb-4 mt-2">
                                <img src="https://d1d5cy0fmpy9m8.cloudfront.net/images/1719577083dcwcw.webp"
                        ...
                        <div
                            ...
                            <p class="col-span-2 text-orange-600">
                                ...
                                <span class="block text-[12px] text-gray-800 font-[600]"> 30 Months Gold Membership of
                                    Kazumi Language School, School of Languages</span>
                            </p>
                            <div class="relative h-fit mx-auto mb-4 mt-2">
                        ...
                        <div
                            ...
                            <p class="col-span-2 text-orange-600">
                                ...
                                <span class="block text-[12px] text-gray-800 font-[600]">
                                    Get free access to the LMS having PPTs, projects, self-paced video-based learning,
                                    library, quizzes, question bank, practice tests, final assessments, and a forum,
                                    powered by Examopedia
                                </span>
                            </p>
                            <div class="relative h-fit mx-auto mb-4 mt-2">
                ...
                <p class="text-[15px] text-left my-8">
                    <span class="font-bold text-gray-900">ア (Kyaria) development </span> lays focus on the essentials
                    for acquiring a good career or diving into a highly competent one. It includes:
                </p>
                ...
                <ul class="disk">
                    <li class="grid md:grid-cols-2 grid-cols-1 gap-4 justify-between">
                        <div
                            class="text-[15px] py-2 text-left font-[600] grid grid-cols-3 gap-2 border-b border-purple">
                            <p class="col-span-2 text-orange-600">
                                7: 特徴 (Tokuchō) Certification + License
                        ...
                        <div
                            ...
                            <p class="col-span-2 text-orange-600">
                                ...
                                <span class="block text-[12px] text-gray-800 font-[600]">Get Internship Support with
                                    Kazumi Language School and in top MNCs like J.P. Morgan, Accenture &amp; many more
                                    via 100X Suite and Yuva Intern</span>
                            </p>
                            <div class="relative h-fit mx-auto mb-4 mt-2">
                                <img src="https://d1d5cy0fmpy9m8.cloudfront.net/images/1719575988d233dd23d.webp"
