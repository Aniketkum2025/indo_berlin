        ...
        <div class="grid h-auto items-center place-items-center grid-flow-row gap-2  md:grid-cols-2">
            <div class="ml-3 rounded-md bg-red-600 px-3 py-5">
                ...
                <div id="countdown-timer2" class="mt-4 flex items-center justify-center gap-1 text-[13px] text-white">
                    ...
                    <p class="rounded-sm bg-[#fea101] px-1 font-[500]">
                        <strong id="hours" class="bold-number font-[500]"></strong> <span
                            class="slim-countdown-text">H<span class="hide-words">ours</span></span>
                    </p>
                    <p class="rounded-sm bg-[#fea101] px-1 font-[500]">
                        <strong id="mins" class="bold-number font-[500]"></strong> <span
                            class="slim-countdown-text">M<span class="hide-words">inutes</span></span>
                    </p>
                    <p class="rounded-sm bg-[#fea101] px-1 font-[500]">
...
@if ($test <= '2025-10-01 00:00:00')
    <script async>
        ...
        function countdown1() {
            ...
            const totalSeconds1 = (newYearsDate1 - currentDate1) / 1000;
            ...
            daysEl1.innerText = days1;
            hoursEl1.innerText = hours1;
            minsEL1.innerText = minutes1;
            secondsEL1.innerText = seconds1;
        }
