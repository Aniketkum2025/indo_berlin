                ...
                <li class="flex flex-wrap items-center gap-4 content-between justify-center">
                    ...
                    <a aria-label="koapp"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24"
                            viewBox="0 0 48 48">
                            <path fill="#ffc107"
                                d="M27.103,5.312c-0.06-0.681-0.408-3.24-2.294-3.595c-0.452-0.085-1.279,0.421,0.587,1.767 c-0.204-0.152-1.836-1.323-2.187-0.126c-0.086,0.292-0.28,0.84,1.559,1.349c0,0-1.565-0.505-1.639,0.417 C23.624,5.051,24.124,5,24.636,5C25.482,5,26.305,5.115,27.103,5.312z">
                            </path>
                            <path fill="#ffc107"
                            ...
                            <path fill="#ffc107"
                                d="M17.487,26.647c0.754-2.303-1.084-5.442-2.799-6.537c-1.409,1.986-3.894,5.793-4.538,8.684 C14.229,29.377,16.837,28.631,17.487,26.647z">
                            </path>
                            <path fill="#ffc107"
                                d="M36.784,21.48c0.541,3.667,0.376,6.583-0.141,8.876C40.665,29.547,40.049,25.489,36.784,21.48z">
                            </path>
                            <circle cx="24" cy="16" r="1" fill="#212121"></circle>
                            <circle cx="31" cy="16" r="1" fill="#212121"></circle>
                            <path fill="#c62828"
                                d="M25.881,18.306l1.53-0.755c0.071-0.035,0.154-0.034,0.225,0.002l1.474,0.758	c0.179,0.092,0.181,0.348,0.004,0.443l-1.447,0.775c-0.072,0.038-0.157,0.04-0.23,0.003l-1.557-0.778	C25.695,18.661,25.695,18.397,25.881,18.306z">
                            </path>
                        </svg>
                    </a>
            ...
            <div class="ml-3 rounded-md bg-red-600 px-3 py-5">
                ...
                <div id="countdown-timer2" class="mt-4 flex items-center justify-center gap-1 text-[13px] text-white">
                    <p class="rounded-sm bg-[#fea101] px-1 font-[500]">
                        <strong id="days" class="bold-number font-[500]"></strong> <span class="slim-countdown-text">D<span class="hide-words">ays</span></span>
                    </p>
                    <p class="rounded-sm bg-[#fea101] px-1 font-[500]">
                        <strong id="hours" class="bold-number font-[500]"></strong> <span class="slim-countdown-text">H<span class="hide-words">ours</span></span>
                    </p>
                    <p class="rounded-sm bg-[#fea101] px-1 font-[500]">
                        <strong id="mins" class="bold-number font-[500]"></strong> <span class="slim-countdown-text">M<span class="hide-words">inutes</span></span>
                    </p>
                    <p class="rounded-sm bg-[#fea101] px-1 font-[500]">
                        <strong id="seconds" class="bold-number font-[500]"></strong> <span class="slim-countdown-text">S<span class="hide-words">econds</span></span>
                    </p>
                </div>
            </div>
            <div class="px-4">
                <div class="flex items-center justify-between p-4 md:p-2 border-b rounded-t">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center" data-modal-hide="authentication-modal2">
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 1l12 12M1 13L13 1"/>
                        </svg>
                        <span class="sr-only">Close modal</span>
                ...
                <form class="p-4 md:p-2 space-y-1" action="{{ route('lead.store') }}" method="POST">
                    ...
                    <div>
                        <label for="name" class="block text-sm mb-1 font-[600] text-red-600">Name</label>
                        <input type="text" name="name" id="name" placeholder="Name" required class="bg-gray-50 border border-red-300 text-gray-900 text-sm rounded-lg block w-full p-1.5">
                        <span id="name_error3" class="text-red-500 text-xs"></span>
                    </div>

                    <div>
                        <label for="email" class="block text-sm mb-1 font-[600] text-red-600">Email</label>
                        <input type="email" name="email" id="email" placeholder="Email" required class="bg-gray-50 border border-red-300 text-gray-900 text-sm rounded-lg block w-full p-1.5">
                        <span id="email_error3" class="text-red-500 text-xs"></span>
                    </div>
                    ...
                    <div>
                        <label for="countryCode" class="block text-sm mb-1 font-[600] text-red-600">Country Code</label>
                        <div class="flex gap-2">
                            <select name="countryCode" class="w-4/12 bg-gray-50 border border-red-300 text-gray-900 text-sm rounded-lg p-1.5">
                                <option value="IN" value="+91" selected="">(+91)</option>
                                <option value="PK" value="+92">Pakistan (+92)</option>
                                <option value="US" value="+1">USA (+1)</option>
                                <option value="GB" value="+44">UK (+44)</option>
                            ...
                            <input type="number" name="sendto" placeholder="Mobile no *" class="bg-gray-50 border border-red-300 text-gray-900 text-sm rounded-lg block w-full p-1.5">
                        </div>
                        <span id="phone_error3" class="text-red-500 text-xs"></span>
                    </div>
                    <input type="hidden" name="source" class="textbox" value="KAZUMI WEBSITE" placeholder="" />
