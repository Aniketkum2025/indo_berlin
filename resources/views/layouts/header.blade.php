...
@endphp
@if ($test <= '2025-11-01 00:00:00' ) <section class="bg-[#4f2d7f] top-0 z-50 offer-header"
            ...
            <div class="flex justify-between items-center ">
                <div class="flex items-center space-x-3">
                    <a href="/">
                        <img class="md:h-[65px] h-[60px] w-auto"
                            src="https://d1d5cy0fmpy9m8.cloudfront.net/images/1764416873Logo_Indo_Berlin.png"
                            alt="indo Logo">
                    </a>
                </div>
                ...
                <div class="hidden md:flex md:space-x-6">
                    ...
                    <div x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false"
                        ...
                        <!-- Menu Button -->
                        <a
                            class="flex items-center text-orange-600 font-[600] text-[14px] space-x-1 py-6 cursor-pointer">
                            <span>Courses</span>
                        ...
                        <div x-show="open" x-cloak x-transition
                            ...
                            <a href="{{ $hc->slug }}"
                                class="block text-gray-700 hover:text-orange-600 text-[14px] font-[600] hover:bg-gray-100 px-2 py-1">{{ $hc->course_name }}</a>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="group relative">
                        ...
                        <div
                            ...
                            <a href="quality-assurance"
                                class="block text-gray-700 hover:text-orange-600 text-[14px] font-[600] hover:bg-gray-100 px-2 py-1">Quality
                                Assurance</a>
                            ...
                            {{-- <a href="kazumi-community"
                                class="block text-gray-700 hover:text-orange-600 text-[14px] font-[600] hover:bg-gray-100 px-2 py-1">Kazumi Community</a> --}}
                            <a href="contact-us"
                    ...
                    {{-- <a href="/contact-us" class="text-orange-600 font-[600] text-[14px] py-6">Contact Us</a> --}}
                </div>
                ...
                <div class="hidden md:flex md:items-center space-x-4">
                    <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
                        type="button" class="bg-orange-600 text-white px-4 py-2 rounded-md text-sm">Apply</button>
                </div>
                @endif
        ...
        <div id="mobile-menu" class="md:hidden hidden bg-white border-t">
            ...
            <div class="px-4 py-2">
                ...
                <div id="mobile-submenu-courses" class="hidden mt-2 border-orange-600 px-2 border">
                    ...
                    <div class="space-y-2">
                        @foreach ($hhcourses as $hc)
                        <a href="{{ $hc->slug }}"
                            class="block text-gray-700 text-[14px] mb-1 text-orange-700 font-[600] ">{{ $hc->course_name }}</a>
                        @endforeach
                        {{-- </div> --}}
                    </div>
                </div>
            ...
            <div class="px-4 py-2">
                ...
                <div id="mobile-submenu-admission" class="hidden mt-2 mt-2 space-y-2 border-orange-600 px-2 border">
                    ...
                    <a href="admission-process"
                        class="block text-gray-700 text-[14px] mb-1 text-orange-700 font-[600]">Admission Process</a>
                    <a href="https://www.henryharvin.com/pay-fee"
                        class="block text-gray-700 text-[14px] mb-1 text-orange-700 font-[600]">Online Payment</a>
                    <a href="existing-students"
                        class="block text-gray-700 text-[14px] mb-1 text-orange-700 font-[600]">Existing Students</a>
                    <a href="https://www.henryharvin.com/request-certificate"
                        class="block text-gray-700 text-[14px] mb-1 text-orange-700 font-[600]">Request
                        Certificate</a>
                    <a href="contact-us" class="block text-gray-700 text-[14px] mb-1 text-orange-700 font-[600]">Contact
                        Us</a>
                </div>
            </div>
            ...
            <a href="accreditation"
                class="block px-4 py-2 text-orange-600 font-[600] hover:bg-gray-100">Accreditation</a>
            ...
            <div class="px-4 py-2">
                ...
                <div id="mobile-submenu-about" class="hidden mt-2 space-y-2 border-orange-600 px-2 border">
                    <a href="about-us" class="block text-gray-700 text-[14px] mb-1 text-orange-700 font-[600]">Knowing
                        Kazumi</a>
                    ...
                    <a href="/our-affiliations"
                        class="block text-gray-700 text-[14px] mb-1 text-orange-700 font-[600]">Our Affiliations</a>
                    <a href="esteemed-faculty"
                        class="block text-gray-700 text-[14px] mb-1 text-orange-700 font-[600]">Esteemed Faculty</a>
                    <a href="/careers"
                        class="block text-gray-700 text-[14px] mb-1 text-orange-700 font-[600]">Careers</a>
                    <a href="/our-customers" class="block text-gray-700 text-[14px] mb-1 text-orange-700 font-[600]">Our
                        Customers</a>
                    <a href="/placed-students-list"
                        class="block text-gray-700 text-[14px] mb-1 text-orange-700 font-[600]">Placed
                        Student List</a>
                </div>
            </div>
            ...
            <div class="flex space-x-4 px-4 py-2">
                <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" type="button"
                    class="bg-orange-600 text-white px-4 py-2 rounded-md text-sm">Apply</button>
            </div>
            @endif
        </div>
    </nav>
