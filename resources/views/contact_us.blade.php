            ...
            <div class=" w-full" bis_skin_checked="1">
                ...
                <div class="grid grid-cols-2 gap-1 md:gap-7 mt-3" bis_skin_checked="1">
                    <a href="tel: +12093823469"
                        class="rounded-md hover:bg-gray-100 flex text-[12px] md:text-[20px] items-center justify-center p-2 md:p-4 bg-white text-gray-900 border-2 border-[#ffc107] font-[600] rounded-md">
                        <img class="mr-2 md:mr-4"
                            src="https://cdn.henryharvin.com/16697124741669712473ezgif.com-gif-maker(5).png" alt="IN Flag"
                            width="30" height="13" loading="lazy"> +1 209 904 4552
                    </a>
                        ...
                        <div class="w-full">
                            <div class="">
                                ...
                                <a href="https://www.youtube.com/shorts/us9oQ_d8WmE" target="_blank"
                                    ...
                                    <!-- Button Text -->
                                    <span class="text-[#4f2d7f]" style="color:black">Bangalore office in just 30
                                        sec.</span>
                                </a>
                            </div>
                        </div>
