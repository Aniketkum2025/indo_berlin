...
<section>
    <div class="relative w-full h-screen overflow-hidden" style="background-size: cover; background-repeat: no-repeat; background-image: url(https://d1d5cy0fmpy9m8.cloudfront.net/images/1753942717banner.webp); background-position: top;">
        ...
        <div
            ...
            <h1 class="text-2xl md:text-[44px] tracking-widest mb-10 leading-8 font-[600] md:leading-[60px] leading-[30px]" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.35);">Welcome to Kazumi Japanese & Culture School learn With Expert </h1>
