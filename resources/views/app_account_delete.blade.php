    ...
    <div class="container d-flex align-items-center justify-content-center min-vh-100">
        <div class="w-100" style="max-width: 640px;">
            <div class="text-center mb-4">
                <p>Please be advised that the deletion of your account and associated data is a permanent action. Once your request is processed, all information linked to your account will be irretrievably removed from our systems.</p>
                <h4>Request for Account Deletion</h4>
                <p>To initiate the process of deleting your account and the associated data stored in our system, please submit a formal request. Upon receipt of your request, you will receive a One-Time Password (OTP) for confirmation purposes.</p>
            ...
            <div class="card p-4 bg-white">
                <form method="POST" action="" id="mainForm">
                    ...
                    <div class="mb-3 hidden" id="input_otp">
                        <input type="number" class="form-control" name="otp" id="otp" placeholder="Enter OTP" required />
                    </div>
